...
DEF_MAP_SCENARIOS = {
    ...
    'Green_globalLimit': 'Go RES 0.9',
    'NECPEssentials_globalLimit': 'NECP Essentials 0.9',
    'REPowerEU_globalLimit': 'REPowerEU++ 0.9',
    'Trinity_globalLimit': 'Trinity 0.9',
    'GoRES_globalLimit': 'Go RES 0.9',
}
...
DEF_MAP_FILE_SCENARIOS = {
    ...
    'GoRES': 'Go RES 0.9',
    'NECPEssentials': 'NECP Essentials 0.9',
    'REPowerEU++': 'REPowerEU++ 0.9',
    'Trinity': 'Trinity 0.9'
}
